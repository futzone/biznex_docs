			...
			sidebar: [
...

				{
					...
					items: [
						...
						{ label: '🏷️ Markirovka', slug: 'tax-modul/markirovka' },
...

				{
					...
					items: [
						...
						{ label: '🏷️ Raqamli markirovka', slug: 'qonunchilik-modul/markirovka' },
						{ label: '🍷 Quyib sotish', slug: 'qonunchilik-modul/quyib-sotish' },
						{ label: '⚖️ Jarima va javobgarlik', slug: 'qonunchilik-modul/jarima' },
