...
- **Maosh hisoblash** — xodim savdolari asosida maosh va komissiya hisoblash dialogi
...
- Ulangan to'lov terminallari holati (COM port orqali)
...
| Davr | Tavsif |
|------|--------|
| **Bugun** | Joriy kunning ma'lumotlari |
| **Kecha** | O'tgan kunning yakuniy hisoboti |
| **Shu hafta** | Joriy haftaning umumiy ko'rsatkichlari |
| **Shu oy** | Joriy oyning to'liq hisoboti |
| **Maxsus** | Istalgan sana oralig'i (dan — gacha) |
